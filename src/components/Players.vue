<template>
    <div>
        <div class="player-panel" :class="{active:activePlayer === 0 && !this.isWinner,
            ...
            <div class="player-panel" :class="{active:activePlayer === 1 && !this.isWinner,
...
export default {
    ...
    methods:{
        getNamePlayer(index){
            ...
            //nguoi hien tai, nguoi thang cuoc
